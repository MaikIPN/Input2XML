...
function parseBANDEL(line,recordData,isXML){
    try {
        ...
        recordData.commonData.TRACK1 = line.substring(153,219); //Track1
        recordData.commonData.TRACK2 = line.substring(222,259); //Track2
        ...
        */  
        ...
        recordData.commonData.TAG_57 = recordData.commonData.TRACK2.replace("=","D");
        //  recordData.commonData.TAG_57 = recordData.commonData.TRACK2.replace("=","D").substring(0,29)+recordData.commonData.VAR09+"00000F";
        recordData.commonData.TAG_8F = "FF";
        recordData.commonData.TAG_5F34 = recordData.varData.VAR17.replace("=","D");
...
function lineInputNTxml(recordData){
    ...
    if(recordData.commonData.CARDGRAPHICAL){
        line = line + "<CardGraphical GraphPos=\"1\" GraphValue=\""+ recordData.varData.VAR10 +"\"/>\n";
        line = line + "<CardGraphical GraphPos=\"2\" GraphValue=\""+ recordData.varData.VAR11 +"\"/>\n";
        line = line + "<CardGraphical GraphPos=\"3\" GraphValue=\""+ recordData.varData.VAR12 +"\"/>\n";
        line = line + "<CardGraphical GraphPos=\"4\" GraphValue=\""+ recordData.varData.VAR09 +"\"/>\n";
